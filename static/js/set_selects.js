...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const selectedRegionIndex = selectRegionButton.value;
    
    setOptions(regiones, selectRegionButton);
    setOptions(comunasRegion[selectedRegionIndex], selectComunaButton);
});
...
function setOptions (comunas, selectGroup) {
    let c = 0;
